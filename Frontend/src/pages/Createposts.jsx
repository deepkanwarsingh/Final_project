  ...
  return (
    <div>
        ...
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
          <input onChange={(e)=>setTitle(e.target.value)} type="text" placeholder='Enter post title' required className='px-4 py-2 outline-none border-2'/>
          ...
          <textarea onChange={(e)=>setDesc(e.target.value) } rows={15} cols={30} className='px-4 py-2 outline-none border-2' required placeholder='Enter post description'/>
